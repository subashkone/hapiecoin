...
- Env vars (names only; values never in the repo): `DATABASE_URL`, `REDIS_URL`, `BETTER_AUTH_SECRET`, `RAZORPAY_KEY_ID`, `RAZORPAY_KEY_SECRET`, `DELTA_API_KEY`, `DELTA_API_SECRET` (live only, absent in test).
