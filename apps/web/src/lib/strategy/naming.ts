...
export const TEMPLATE_CODES: Readonly<Record<string, string>> = {
  ...
  Collar: "COLLAR",
  "Covered Put": "CP",
  "Synthetic Straddle": "SYNSTD",
  "Call Back Spread 1x2": "CBKS",
  "Put Back Spread 1x2": "PBKS",
  "Diagonal Call": "DCAL",
  "Diagonal Put": "DPUT",
  "Risk Reversal": "RR",
  "Broken-Wing Put Butterfly": "BWPBF",
  "Broken-Wing Call Butterfly": "BWCBF",
  "Double Diagonal": "DDIAG",
  "Calendar Strangle": "CALSTG",
  "Call Ratio Spread 1x2": "CRS",
  "Put Ratio Spread 1x2": "PRS",
  "Short Call Ladder": "SCL",
  "Short Put Ladder": "SPL",
  "Call Spread": "CS",
  "Put Spread": "PS",
  "Call Calendar": "CCAL",
  "Put Calendar": "PCAL",
