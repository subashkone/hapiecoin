...
import type { LivePosition, Strategy, Underlying } from "@hapiecoin/schema";
...
export function driftFor(positions: readonly LivePosition[], strategies: readonly Strategy[], lotSizeOf: (asset: Underlying) => string): Map<string, DriftRow[]> {
