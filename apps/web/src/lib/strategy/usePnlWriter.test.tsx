...
const strat = (id: string, status: Strategy["status"] = "paper"): Strategy => ({ id, name: id, asset: "BTC", status, tradingMode: status === "draft" ? null : "paper", templateName: "Custom", brokerId: "brk_delta", legs: [LEG], realizedPnl: "0", pnlHistory: [], notes: "", tags: [], orderBatchId: null, orders: [], startedAt: AT, closedAt: null, createdAt: AT, updatedAt: AT });
