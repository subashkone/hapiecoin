...
describe("[WORKSPACE] HC-WS-001..006 two-pane shell", () => {
  it("has every left tab enabled, Phase 3 / 4 placeholders on Paper / Live / Journal, and the analysis tabs on the right", async () => {
    ...
    expect(screen.getByTestId("tab-paper").getAttribute("title")).toBe("Arrives in Phase 3");
    ...
    expect(screen.getByTestId("placeholder-paper").textContent).toContain("Paper arrives in Phase 3");
