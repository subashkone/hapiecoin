...
export function PayoffPanel() {
  ...
  const ivOptions = (shift: number, on: boolean): ScenarioOptions | null => (on && result && spot !== null ? { prices: ivPrices, dates: [result.targetMs], ivShift: shift, mode: "pnl", defaultIv: 0.5, calendar: venueCalendar(a.asset, a.venue) } : null);
