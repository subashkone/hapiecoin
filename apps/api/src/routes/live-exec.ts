...
export async function preview(deps: AppDeps, user: SessionUser, strategy: StrategyRow, legs: readonly PlanLeg[], brokerId: string, worstLoss: number | null, exits: readonly PlanLeg[] = [], accountId: string | null = null, wallets?: WalletCache): Promise<LivePreview> {
  const reasons: string[] = [];
