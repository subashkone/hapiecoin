...
describe("[SCHEMA] billing", () => {
  ...
  it("admin rows and patches: validity, commission 0..100, lot sizes > 0, and nothing-to-update", () => {
    const row = AdminUserRow.parse({ id: "usr_1", email: "a@b.c", name: "A", role: "user", active: true, planName: null, planId: null, interval: null, startsAt: null, expiresAt: null, validityDays: null, referrals: 0, commissionPct: "0", limitOverrides: {}, lotSizes: { BTC: "0.001" }, createdAt: AT });
