...
9. 🔨 Backtest and replay on our own IV / mark snapshots: B9a end-of-day chain table + runBacktest + GET /v1/backtest + the Backtest tab · MERGED 12 Sep 2026 as PR #82 (ADR-077; HC-SH-128, HC-TR-184..185; GAPS #93) · B9b replay of an expiry's chain (daily over chain_eod, 5-minute over the last week of instrument_marks; the Builder's legs marked from recorded marks) · BUILT on feat/replay (ADR-079; HC-WS-113..114; GAPS #95)
