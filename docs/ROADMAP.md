...
7. ✅ Verified P&L: B7a fills read per key + realised P&L from fills + the Journal block with the agreement line · MERGED 12 Sep 2026 as PR #78 (ADR-073; HC-TR-179..181; GAPS #89) · B7b public page per trader at /t/<handle> (chosen handle, off by default, totals net of fees, opt-in daily chart / accounts / months) + share to X, Telegram, copy link, PNG card · MERGED 12 Sep 2026 as PR #81 (ADR-075; HC-SH-127, HC-PB-066, HC-PB-067; GAPS #91)
...
9. ✅ Backtest and replay on our own IV / mark snapshots · B9a end-of-day chain table + runBacktest + GET /v1/backtest + the Backtest tab MERGED 12 Sep 2026 as PR #82 (ADR-077; HC-SH-128, HC-TR-184..185; GAPS #93) · B9b replay of an expiry's chain MERGED 12 Sep 2026 as PR #84 (ADR-079; HC-WS-113..114; GAPS #95)
...
12. 🔨 Phone pass on the workspace, cards and dialogs · BUILT on feat/phone-pass (ADR-080; HC-SH-130..131, HC-WS-115; GAPS #96): scrolling tab strips, compact header below 768 px, the chain pans by touch and acts on tap with finger-sized controls, tables scroll inside their container, a Pixel 7 Playwright project (phone.spec.ts) with analyse-phone captures
