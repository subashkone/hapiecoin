...
| HC-WS-016 | 41 strikes around ATM from CG.chain(asset, expiry) with a strike-range control (±6 / ±12 / all), auto-scrolled to ATM | Range persisted in CG.state.chainRange (default ±12); the footer reports "n of 41 strikes" | built | e2e (Playwright) |
